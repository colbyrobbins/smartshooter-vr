...
<img width="480" alt="smartshooter_lvl1_demo" src="https://github.com/user-attachments/assets/3792114e-01a2-4ecb-b548-77e58cff7b55" />

### Level 2

<img width="480" alt="smartshooter_lvl2_demo" src="https://github.com/user-attachments/assets/934fb173-34e1-48fc-a6f9-5181057f6078" />
...
- **Level Two** — the player faces a grid of targets but can only see the starting and goal targets at first. Targets adjacent to a hit target become visible as the player clears a path, so the player has to shoot their way from the start target to the goal target through a hidden layout.
